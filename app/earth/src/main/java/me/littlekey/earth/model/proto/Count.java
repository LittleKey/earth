...
public final class Count extends Message<Count, Count.Builder> {
  ...
  public Count(Float rating, Integer selected_num, Integer likes, Integer pages, Integer rating_count, Integer number) {
    this(rating, selected_num, likes, pages, rating_count, number, ByteString.EMPTY);
  }

  public Count(Float rating, Integer selected_num, Integer likes, Integer pages, Integer rating_count, Integer number, ByteString unknownFields) {
  ...
  public static final class Builder extends Message.Builder<Count, Builder> {
    ...
    @Override
    public Count build() {
      return new Count(rating, selected_num, likes, pages, rating_count, number, buildUnknownFields());
    }
  }
