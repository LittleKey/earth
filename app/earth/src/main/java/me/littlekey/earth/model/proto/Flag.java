...
public final class Flag extends Message<Flag, Flag.Builder> {
  ...
  public Flag(Boolean is_admin, Boolean is_me, Boolean is_winner, Boolean is_selected, Boolean can_move, Boolean loading, Boolean is_ready, Boolean in_room, Boolean is_matching) {
    this(is_admin, is_me, is_winner, is_selected, can_move, loading, is_ready, in_room, is_matching, ByteString.EMPTY);
  }

  public Flag(Boolean is_admin, Boolean is_me, Boolean is_winner, Boolean is_selected, Boolean can_move, Boolean loading, Boolean is_ready, Boolean in_room, Boolean is_matching, ByteString unknownFields) {
  ...
  public static final class Builder extends Message.Builder<Flag, Builder> {
    ...
    @Override
    public Flag build() {
      return new Flag(is_admin, is_me, is_winner, is_selected, can_move, loading, is_ready, in_room, is_matching, buildUnknownFields());
    }
  }
