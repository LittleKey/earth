...
// Source file: ./earth.proto at 18:1
...
public final class Flag extends Message<Flag, Flag.Builder> {
  ...
  public static final class Builder extends Message.Builder<Flag, Builder> {
    ...
    @Override
    public Flag build() {
      return new Flag(is_admin, is_me, is_winner, is_selected, can_move, loading, is_ready, in_room, is_matching, is_liked, is_thumbnail, buildUnknownFields());
    }
  }
